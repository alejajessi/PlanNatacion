...
public class SelectPreviousType extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_select_previous_type, container, false);
    }
    ...
    public void inicializarID(View view){
        et_tipoPrueba =  view.findViewById(R.id.tx_info_previous_type);
        avanzar = (Button)view.findViewById(R.id.avan_select_previous_type);
        retroceder = view.findViewById(R.id.retro_select_previous_type);
    }
    ...
    public void funcionAvanzar(NavController nav) {
        avanzar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (campos == true){
                    callback.onCallBack("SelectPreviousType", et_tipoPrueba.getText().toString().trim(), null,null);
                    new Timer().schedule(new TimerTask() {
                        @Override
                        public void run() {
                            if (callback.onCallBackCambioFragment()){
                                Navigation.findNavController(v).navigate(R.id.nav_show_previous_test);
                                cancel();
                            }
                        }
                    }, 1000);
